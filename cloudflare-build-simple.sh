...
# Skip the Next.js build and create a static HTML file directly
...
# Copy the build output to the Cloudflare Pages directory
echo "📋 Copying build output to Cloudflare Pages directory..."
mkdir -p ../.vercel/output/static
