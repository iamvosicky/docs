      ...
      <section className="hero-gradient relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-32 pb-8 sm:pb-12 relative">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl sm:text-6xl lg:text-[5.5rem] font-bold tracking-tight mb-6 sm:mb-8 leading-[1.05]">
              ...
              <br />
              dokumenty{" "}
              <span className="italic font-serif bg-gradient-to-r from-primary to-[oklch(0.6_0.2_310)] bg-clip-text text-transparent">
                snadno
              </span>
            </h1>

            <p className="text-lg sm:text-xl text-muted-foreground max-w-lg mx-auto leading-relaxed mb-10 sm:mb-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Button asChild variant="ghost" size="lg" className="rounded-full px-8 h-12 text-base text-muted-foreground hover:text-foreground">
                <a href="#use-cases">
                  Jak to funguje
                </a>
              </Button>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-4">
          <div className="max-w-4xl mx-auto relative">
            <div className="relative rounded-2xl border border-border bg-card p-5 sm:p-8 shadow-lg">
              {/* Top bar */}
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium">Založení s.r.o.</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-2 w-2 rounded-full bg-primary" />
                  <span className="text-xs text-muted-foreground">Připraveno</span>
                </div>
              </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div key={f.title} className="rounded-2xl border border-border bg-card p-6 group hover:border-primary/30 transition-colors">
