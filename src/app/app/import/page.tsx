        ...
        <div className="space-y-6">
          <div className="mb-2">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight">Nahrát dokument</h1>
        ...
        <div className="space-y-5">
          <div className="mb-2">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight">Kontrola šablony</h1>
